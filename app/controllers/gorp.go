...
func InitDB() {
	...
	e := Dbm.AddTableWithName(models.EventLog{}, "EventLog").SetKeys(true, "Id")
	e.ColMap("Page").Transient = true
	s := Dbm.AddTableWithName(models.EventLog{}, "SystemLog").SetKeys(true, "Id")
	s.ColMap("Page").Transient = true
